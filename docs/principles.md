...
OdoLog is a fuel log. It does not track insurance renewals, service schedules, tyre pressure, parking spots, or driving routes, and it never sends data anywhere. Requests that move it toward a general vehicle manager will usually be declined.
